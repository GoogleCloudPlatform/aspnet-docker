...
gcloud container images add-tag ${repo}/aspnetcore:2.1-${TAG} ${repo}/aspnetcore:2.1.22 --quiet
...
gcloud container images add-tag ${repo}/aspnetcore:3.1-${TAG} ${repo}/aspnetcore:3.1.9 --quiet
